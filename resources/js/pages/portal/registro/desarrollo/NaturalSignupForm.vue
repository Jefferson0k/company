  ...
  <form :class="cn('flex flex-col gap-5', props.class)">
    <FieldGroup>
      <div class="flex flex-col items-center gap-1 text-center">
        <h1 class="text-2xl font-bold">Crear tu cuenta</h1>
        <p class="text-muted-foreground text-sm">Completa el formulario para registrarte</p>
      </div>

      <div class="grid grid-cols-2 gap-4">
        <Field>
          <FieldLabel for="nombres">Nombres</FieldLabel>
          <Input id="nombres" type="text" placeholder="Juan" required />
        </Field>
        <Field>
          <FieldLabel for="apellidos">Apellidos</FieldLabel>
          <Input id="apellidos" type="text" placeholder="Pérez" required />
        </Field>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <Field>
          ...
          <Input id="dni" type="text" placeholder="12345678" maxlength="8" required />
        </Field>
        <Field>
          <FieldLabel for="celular">Celular</FieldLabel>
          <Input id="celular" type="tel" placeholder="987 654 321" required />
        </Field>
      </div>
      ...
      <Field>
        ...
        >
          ...
          <input id="comprobante" type="file" accept="image/*,.pdf" class="hidden" @change="onFileChange" required />
        </label>
      ...
      <Field>
        <div class="flex items-start gap-3">
          <Checkbox id="terminos" v-model:checked="aceptaTerminos" />
          <label for="terminos" class="text-sm leading-snug cursor-pointer">
            Acepto los
